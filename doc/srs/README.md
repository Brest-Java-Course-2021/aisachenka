...
- Если данные не введены, то фильтрация осуществляется, но видимого результата не дает, просто обновляет страницу.
- Если данные захардкожены через URL строку и захардкожены неправильно, то выводится форма ошибки: “Woops, something went wrong”;
